  ...
  return (
    <div className="sidebar sticky top-0 w-64 h-screen border-r border-slate-200 flex flex-col justify-between py-5 font-normal">
      <div className="w-full space-y-4">
        ...
        <div className="flex flex-col w-full space-y-2 text-zinc-500">
          <a
            href="/"
            className="px-5 py-2 flex items-center hover:bg-zinc-100 transition-all"
          >
            <svg
          ...
          <a
            href="/"
            className="px-5 py-2 flex items-center text-zinc-900 border-r-2 border-r-black hover:bg-zinc-100 transition-all"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
